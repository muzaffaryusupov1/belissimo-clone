...
const AboutDigital = () => {
	return (
		<section id='about-digital' className='bg-[#e9edee]'>
			<div className='container'>
				<div className='py-[140px] flex flex-col items-center justify-between'>
					<div>
						<h1 className='text-black poppins text-[55px] not-italic font-normal leading-[1.181] tracking-[-1.1px]'>
							Raqamli yechimlar
						</h1>
						<p className='text-2xl text-[#9095a2] not-italic font-normal leading-[1.5] tracking-[-.48px] mt-5 mb-[60px]'>
							Buyurtma berishda
					...
					<div className='flex items-center justify-center gap-5'>
						<div className='overflow-hidden relative text-center text-white rounded-[10px] h-full'>
							...
							<div className='absolute top-10 left-10 poppins text-[32px] not-italic font-normal leading-[1.375]'>
								Mobil dastur
							</div>
						...
						<div className='flex flex-col gap-[15px]'>
							<div className='overflow-hidden relative text-center text-white rounded-[10px] h-full'>
								...
								<div className='text-black absolute top-10 left-10 poppins text-[32px] not-italic font-normal leading-[1.375]'>
									<p className='text-center'>Telegram bot</p>
								</div>
								<Badge className='absolute bottom-10 left-10 py-[11.5px] px-[25px] rounded-[35px] text-black text-center text-base not-italic font-normal leading-normal bg-white'>
